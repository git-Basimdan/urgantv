...
dependencies {
    ...
    // Kanal bazlı proxy desteği için: ExoPlayer'ın varsayılan HTTP katmanı proxy ayarlamıyor,
    // OkHttp ise Proxy(host, port) ve kimlik doğrulamayı doğrudan destekliyor.
